...
## Toevoegingen obv bestudering [Wlz](https://wetten.overheid.nl/BWBR0035917/2021-01-01) op wetten.nl:
...
## Artikel 3.3.1. beschrijft **leveringsvorm**
## Een client kan een combinatie van leveringsvormen krijgen.
## Hoofdstuk 9 gaat over **informatiebepaling**. NZA zou kunnen willen weten hoe de informatieverstrekking is gegaan.
## zorg: **zorg** en overige **dienst**en als bedoeld in artikel 3.1.1;
## ADL-assistentie
## Definities op https://www.zorginstituutnederland.nl/Verzekerde+zorg
## Er is een onderscheid tussen clienten met een migratie achtergrond en in NL wonend.
##
