...
### Veel platformen bieden de mogelijkheid een eigen **rule set** te maken. Is dit relevant voor kik-v? Reasoning betekent minder operationele data vastleggen voor de zelfde informatie behoefte wat zich onderscheid van traditionele technieken. Voorbeeld redenering: Bij een decubitusGraad krijgt de client de status XYZ.
### Naast ontologie ontwerp is er dus ook entailment rule ontwerp.
