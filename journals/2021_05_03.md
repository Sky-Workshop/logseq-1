...
### Voorbeeld redenering: Bij een decubitusGraad krijgt de client de status XYZ.
...
### Veel platformen bieden de mogelijkheid een eigen rule set te maken. Is dit relevant voor kik-v? Reasoning betekent minder data vastleggen voor de zelfde informatie behoefte. De sparql queries moeten getest worden op een graaf inclusief de inferred triples.
